...
<!-- Mirrored from w3crm.dexignzone.com/xhtml/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Nov 2023 16:20:39 GMT -->
<head>
    <meta charset="utf-8">
	...
	<link href="{{asset('assets/https://fonts.googleapis.com/css2?family=Material+Icons')}}" rel="stylesheet">
	<link rel=" {{asset('assets/stylesheet" href="../../cdnjs.cloudflare.com/ajax/libs/noUiSlider/14.6.4/nouislider.min.css')}}">
									...
									<div class="dropdown-menu dropdown-menu-end" style="">
										<div class="card border-0 mb-0">
											...
											<div class="card-footer px-0 py-2">
												...
												<a class="dropdown-item" href="{{ route('logout') }}" class="dropdown-item ai-icon"	onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
												<svg class="profle-logout" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#ff7979" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path><polyline points="16 17 21 12 16 7"></polyline><line x1="21" y1="12" x2="9" y2="12"></line></svg>
													<span class="ms-2 text-danger">Logout </span></a>
		...
		<div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
					...
					<li><a href="{{route('organization.index')}}" class="" aria-expanded="false">
						<div class="menu-icon">
