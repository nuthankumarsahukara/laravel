									...
									<table id="projects-tbl" class="table ItemsCheckboxSec">
										...
										<tbody>
											...
											<tr>
												...
												<td>
													<div class="d-flex align-items-center">
														<img src="{{asset('assets/images/contacts/pic888.jpg')}}" class="avatar rounded-circle" alt="">
											...
											<tr>
												...
												<td>
													<div class="d-flex align-items-center">
														<img src="{{asset('assets/images/contacts/pic999.jpg')}}" class="avatar rounded-circle" alt="">
														<p class="mb-0 ms-2">Elijah James</p>	
													</div>
												</td>
												<td class="pe-0">
									...
									<table id="product-tbl" class="table ">
										...
										<tbody>
											<tr>
												...
												<td>
													<div class="products">
														<img src="{{asset('assets/images/contacts/d1.jpg')}}" class="avatar avatar-md" alt="">
														<div>
											...
											<tr>
												...
												<td>
													<div class="products">
														<img src="{{asset('assets/images/contacts/d2.jpg')}}" class="avatar avatar-md" alt="">
														<div>
											...
											<tr>
												...
												<td>
													<div class="products">
														<img src="{{asset('assets/images/contacts/d3.jpg')}}" class="avatar avatar-md" alt="">
														<div>
											...
											<tr>
												...
												<td>
													<div class="products">
														<img src="{{asset('assets/images/contacts/d5.jpg')}}" class="avatar avatar-md" alt="">
														<div>
											...
											<tr>
												...
												<td>
													<div class="products">
														<img src="{{asset('assets/images/contacts/d6.jpg')}}" class="avatar avatar-md" alt="">
														<div>
											...
											<tr>
												...
												<td>
													<div class="products">
														<img src="{{asset('assets/images/contacts/d7.jpg')}}" class="avatar avatar-md" alt="">
														<div>
											...
											<tr>
												...
												<td>
													<div class="products">
														<img src="{{asset('assets/images/contacts/d8.jpg')}}" class="avatar avatar-md" alt="">
														<div>
											...
											<tr>
												...
												<td>
													<div class="products">
														<img src="{{asset('assets/images/contacts/d14.jpg')}}" class="avatar avatar-md" alt="">
														<div>
											...
											<tr>
												...
												<td>
													<div class="products">
														<img src="{{asset('assets/images/contacts/d13.jpg')}}" class="avatar avatar-md" alt="">
														<div>
											...
											<tr>
												...
												<td>
													<div class="products">
														<img src="{{asset('assets/images/contacts/d9.jpg')}}" class="avatar avatar-md" alt="">
														<div>
											...
											<tr>
												...
												<td>
													<div class="products">
														<img src="{{asset('assets/images/contacts/d10.jpg')}}" class="avatar avatar-md" alt="">
														<div>
											...
											<tr>
												...
												<td>
													<div class="products">
														<img src="{{asset('assets/images/contacts/d11.jpg')}}" class="avatar avatar-md" alt="">
														<div>
											...
											<tr>
												...
												<td>
													<div class="products">
														<img src="{{asset('assets/images/contacts/d12.jpg')}}" class="avatar avatar-md" alt="">
														<div>
									...
									<table id="empoloyees-tbl" class="table">
										...
										<tbody>
											...
											<tr>
												...
												<td>
													<div class="products">
														<img src="{{asset('assets/mages/contacts/pic1.jpg')}}" class="avatar avatar-md" alt="">
														<div>
															<h6><a href="javascript:void(0)">Ricky Antony</a></h6>
															<span>Software Designer</span>	
														</div>	
